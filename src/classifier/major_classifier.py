...
class MajorClassifier:
    ...
    def classify_jobs(self, jobs) -> None:
        ...
        system_message = (
            ...
            "- Computer Engineering: computer architecture, VLSI, digital systems design, "
            "hardware/software co-design, SoC design — roles requiring both hardware and "
            "software knowledge. Not pure software roles (those are CS) and not pure "
            "circuits/power roles (those are EE)\n"
